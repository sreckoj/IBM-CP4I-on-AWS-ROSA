...
1. In the OpenShift web console navigate to **Operators > Installed Operators**, select the project - in our case **cp4i** and select the **IBM Cloud Pak for Integration** operator:<br>
